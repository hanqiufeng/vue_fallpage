        ...
        <div class="navs">
            <ul id="menu">
                <li data-menuanchor="page1" class="active">
                    <span @click="moveTo(1)">Section 1</span>
                </li>
                <li data-menuanchor="page2">
                    <span @click="moveTo(2,0)">Section 2</span>
                </li>
                <li data-menuanchor="page3">
                    <!-- <a href="#page3">Section 3</a> -->
                    <span @click="moveTo(3)">Section 3</span>
                </li>
                <li>
            ...
            <ul class="actions">
                <li>
                    <a class="actions-button" href="#" rel="noopener" @click="addSection">添加 section</a>
                </li>
                <li>
                    <a class="actions-button" href="#" rel="noopener" @click="removeSection">移除 section</a>
                </li>
                <li>
                    <a class="actions-button" href="#" rel="noopener" @click="toggleNavigation">切换导航</a>
                </li>
                <li>
                    <a class="actions-button" href="#" rel="noopener" @click="toggleScrollbar">切换滚动条</a>
                </li>
            </ul>
        </div>
        <full-page ref="fullpage" :options="options" id="fullpage" class="fullpages">
            <div class="section">
                <h3>Section 1</h3>
            </div>
            <div class="section">
  ...
  data() {
    return {
      options: {
        ...
        menu: "#menu",
        navigation: true,
        anchors: ["apps/page1", "apps/page2", "apps/page3"],
        sectionsColor: [
          "#41b883",
          "#ff5f45",
          "#0798ec",
